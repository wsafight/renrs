...
for (const name of ['renrs','renrs-init','renrs-check','renrs-build','renrs-pack','renrs-web-build','renrs-graph']) if (!tools.includes(name) && !tools.includes(`${name}.exe`)) throw new Error(`Missing ${name}`);
